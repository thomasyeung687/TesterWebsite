 ...
 */
@WebServlet("/QuestionfillinmultipleblanknextServlet")
public class QuestionfillinmultipleblanknextServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("Questionfillinmultipleblank2.jsp").forward(request, response);
	}
