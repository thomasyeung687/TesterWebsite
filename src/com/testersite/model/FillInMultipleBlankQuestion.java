...
public class FillInMultipleBlankQuestion extends Question{
	...
	public FillInMultipleBlankQuestion(int questionid,  int pointsWorth,String questiontitle, String question, String correctans, boolean casesensitive, boolean partialcredit) {
		...
		/**/eachblankscorrectanswers= Arrays.asList(correctans.split("\\|")); //fat~skinny~big~large~|smelly~disgusting~tasty~|napped~slept~coughed~| -> fat~skinny~big~large~,smelly~disgusting~tasty~,napped~slept~coughed~
	...
	public static void main(String[] arg) {
		FillInMultipleBlankQuestion question = new FillInMultipleBlankQuestion(46, 10,"1", "The [a] cat ate its [b] food and [c]","fat~skinny~big~large~|smelly~disgusting~tasty~|napped~slept~coughed~|", true, true);
