...
<body>
	...
	%>
	<%
	System.out.println("id multipartquestion="+request.getParameter("idmultiquestion"));
	%>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h1></h1>
                     <p style="font-size:25px;">Add Multiple Choice to Multipart Question</p> <a href="">help</a>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr /> <!-- adds line -->
					<form action = "MultipartAddQuestionmultiplechoiceServlet" method="post">
						...
						Question  <input type="text" name="questiontext" required> <%-- <textarea name="questiontext" cols="100" rows="5" >${questiontext}</textarea> --%>
					<hr />
