        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h1></h1>
                     <p style="font-size:25px;">Add Multipart Question</p> <a href="">help</a>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr /> <!-- adds line -->
					<form action = "QuestionmultipartServlet" method="post">
						Question Title <input type="text" name="questiontitle" required> </br>
						Question <textarea name="questiontext" cols="100" rows="5" >${questiontext}</textarea>
					<hr />
					
					
					<input type="hidden" name="idtest" value="<%out.println(request.getParameter("idtest"));%>">
					<button name="action" value="submit">Proceed to Add Questions</button> 
					</form>
