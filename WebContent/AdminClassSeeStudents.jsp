...
<body>
	...
	%>
	<%
	System.out.println("AdminClassSeeStudents.jsp");
	...
	try {
		...
		rset = st.executeQuery("SELECT * FROM testersitedatabase.allclasses WHERE idclass = '"+tclass.getIdclass()+"';");
		rset.next(); 
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                 <h3>Class Code: <%out.println(classcode); %></h3>  <h3>    Add students from .txt file: <a href= FileUploadAdmin.jsp>here</a></h3>
