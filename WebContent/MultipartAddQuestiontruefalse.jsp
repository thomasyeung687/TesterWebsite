        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    <h1></h1>
                     <p style="font-size:25px;">Add True/False to Multipart Question</p> <a href="">help</a>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr /> <!-- adds line -->
                  	<span style =  "color: red;"> ${error} </span><br>                  
					<form action = "MultipartAddQuestiontruefalseServlet" method="post">
					...
					<hr />
						<input type="radio" name="correctans" value="True" required> True <br>
						<input type="radio" name="correctans" value="False" required> False <br>
					<hr />
